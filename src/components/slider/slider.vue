    ...
    <ul class="list">
      ...
      <li>
        ...
        <ol>
          ...
          <li>
            播放动块移动距离 随机 或者 定值
            <fx-button @clickEvt="mosaicSetInfo.positionRandom=!mosaicSetInfo.positionRandom">
              {{mosaicSetInfo.positionRandom?'定值':'随机'}}
            </fx-button>
          </li>
        </ol>
        <div class="box" style="width: 1000px;">
          <fx-slider :data="sliderList"
            ...
            <div style="width: 100%;height: 100%;" v-for="(item,index) in sliderList">
              ...
              <fx-mosaic :playTime="mosaicSetInfo.playTime"
                         ...
                         :isPlayOut="mosaicSetInfo.isPlayOut"
                         :positionRandom="mosaicSetInfo.positionRandom"
...
<script>
  export default {
    ...
    methods: {
      ...
      prevClick() {
        this.mosaicSetInfo.isPlayOut = true;
        setTimeout(() => {
          this.mosaicSetInfo.isPlayOut = false;
        }, this.mosaicSetInfo.playTime)
      },
      nextClick() {
        this.mosaicSetInfo.isPlayOut = false;
      },
